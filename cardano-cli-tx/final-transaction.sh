cardano-cli transaction build \
    ...
    --mint-script-file ~/Cardano/plutus-vasil/plutus-mint-lock-unlock-dapp/jsons/utility-token.plutus \
    --mint-redeemer-file ~/Cardano/plutus-vasil/plutus-mint-lock-unlock-dapp/jsons/unit.json \
    --mint-script-file ~/Cardano/plutus-vasil/plutus-mint-lock-unlock-dapp/jsons/nft-mint-V2.plutus \
    --mint-redeemer-file ~/Cardano/plutus-vasil/plutus-mint-lock-unlock-dapp/jsons/unit.json \
